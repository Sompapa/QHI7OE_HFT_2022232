    ...
    public class MangaDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Manga>().HasData(new Manga[]
            {
                ...
                new Manga("18#Dragon Ball#5,99#6,9#1984*12*3#13#5"),
                new Manga("19#Dragon Ball Z#5,99#7,3#1986*2*26#13#5"),
                new Manga("20#Dragon Ball Super#5,99#6,4#2015*6*20#13#5"),
